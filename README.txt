...
Le script allProcess.sh permet de lancer toutes les parties. Il attend 4 entiers booléens:
	...
	- Le quatrième commande l'apprentissage par renforcement, en générant les données tirées de partie en self-play et en entrainant le strong policy model grâce à elles.
